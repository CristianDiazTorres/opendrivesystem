...
void SetLocalFilesDatabasePathDlg::accept()
{
    ...
    OSMWaySettingsOnPGDatabase_getDefaultInstance.setJsonPath(ui->pathEdt->text() + "/OSM");
    OSMNodeSettingsOnPGDatabase_getDefaultInstance.setJsonPath(ui->pathEdt->text() + "/OSM");
