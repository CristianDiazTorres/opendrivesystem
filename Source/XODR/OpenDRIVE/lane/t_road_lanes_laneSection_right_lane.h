    ...
    <xs:complexType name="t_road_lanes_laneSection_right_lane">
        ...
        <xs:complexContent>
            <xs:extension base="t_road_lanes_laneSection_lr_lane">
                <xs:sequence/>
                <xs:attribute name="id" use="required" type="xs:negativeInteger">
                    <xs:annotation>
...
struct t_road_lanes_laneSection_right_lane : public _t_road_lanes_laneSection_lcr_lane
{
public:
    _OD_MEMBERS(DECLARE, SEMICOLON)
    _UNIVERSIAL_TYPE_isCompatible_operatorEqualNotEqual_DEFINE(t_road_lanes_laneSection_right_lane)
    _UNIVERSIAL_TYPE_read_write_DEFINE(t_road_lanes_laneSection_right_lane)
    _UNIVERSIAL_TYPE_setTestData_DEFINE(t_road_lanes_laneSection_right_lane)
    _UNIVERSIAL_TYPE_updateGeoJSONData_DEFINE(t_road_lanes_laneSection_right_lane)
};
