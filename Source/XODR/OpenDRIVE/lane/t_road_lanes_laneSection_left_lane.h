...
struct t_road_lanes_laneSection_left_lane : public _t_road_lanes_laneSection_lcr_lane
{
public:
    _OD_MEMBERS(DECLARE, SEMICOLON)
    _UNIVERSIAL_TYPE_isCompatible_operatorEqualNotEqual_DEFINE(t_road_lanes_laneSection_left_lane)
    _UNIVERSIAL_TYPE_read_write_DEFINE(t_road_lanes_laneSection_left_lane)
    _UNIVERSIAL_TYPE_setTestData_DEFINE(t_road_lanes_laneSection_left_lane)
    _UNIVERSIAL_TYPE_updateGeoJSONData_DEFINE(t_road_lanes_laneSection_left_lane)
};
