...
#define _OD_MEMBERS(usingType, lineEnd) \
    ...
    _UNIVERSIAL_TYPE_ATTRIBUTE(usingType, t_grEqZero, sOffset, REQUIRED) lineEnd \
    EMPTY_COMMAND

struct a_sOffset : public _OpenDriveElement
{
public:
    _OD_MEMBERS(DECLARE, SEMICOLON)
    _UNIVERSIAL_TYPE_parent_isComp_opENE_RW1_TEST_DEFINE(a_sOffset)
