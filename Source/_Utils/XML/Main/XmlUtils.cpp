...
typedef const XmlCharRange *RangeIter;

/*!
  Performs a binary search between \a begin and \a end inclusive, to check whether \a
  c is contained. Remember that the XmlCharRange instances must be in numeric order.
 */
...
static const XmlCharRange g_base_begin[] =
{
...
static const RangeIter g_base_end = g_base_begin + sizeof(g_base_begin) / sizeof(XmlCharRange);

static const XmlCharRange g_ideographic_begin[] =
{
    {0x3007, 0x3007}, {0x3021, 0x3029}, {0x4E00, 0x9FA5}
};
static const RangeIter g_ideographic_end = g_ideographic_begin + sizeof(g_ideographic_begin) / sizeof(XmlCharRange);
...
static const XmlCharRange g_combining_begin[] =
{
...
static const RangeIter g_combining_end = g_combining_begin + sizeof(g_combining_begin) / sizeof(XmlCharRange);
...
// [88] Digit ::= ...
static const XmlCharRange g_digit_begin[] =
{
...
static const RangeIter g_digit_end = g_digit_begin + sizeof(g_digit_begin) / sizeof(XmlCharRange);
...
// [89] Extender ::= ...
static const XmlCharRange g_extender_begin[] =
{
...
static const RangeIter g_extender_end = g_extender_begin + sizeof(g_extender_begin) / sizeof(XmlCharRange);
