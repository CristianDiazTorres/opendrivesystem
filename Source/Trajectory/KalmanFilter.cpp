...
void KalmanFilter::intialize(double t0, double x0, double y0, double vx0, double vy0, double hdop, double /*velocityMeasureError*/)
{
    dt = -1;
    ...
    // noise model
    //R << hdop,0,0,0,0,hdop,0,0,0,0,velocityMeasureError,0,0,0,0,velocityMeasureError;
    //Z.setRandom();
    //Q.setRandom();
    //Z*=0.1;
    //Q*=0.1;
...
DoubleVec KalmanFilter::predict(double t, double x, double y, double vx, double vy, double ax, double ay)
{
    /*
