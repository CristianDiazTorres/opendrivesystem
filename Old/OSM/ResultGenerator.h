...
#ifndef __OSM_RESULTGENERATOR_H__
#define __OSM_RESULTGENERATOR_H__
...
public:
    ...
    void JsonParserOutput(WayVec& ways);
    void JsonParserOutput(NodeVec& nodes);

    ByteArray GetJSONData(WayVec& ways);
    ByteArray GetJSONData(NodeVec& nodes);

};

}

#endif // __OSM_RESULTGENERATOR_H__
