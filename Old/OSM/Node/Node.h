...
struct Node
{
    ...
    String bollard;
    String bus;
    String capacity_parent;
    String communication_gsm_r;
    String communication_mobile_phone;
    String covered;
    String crossing;
    String crossing_activation;
    String crossing_barrier;
    String crossing_chicane;
    String crossing_island;
    String crossing_light;
    String crossing_saltire;
    String description;
    String direction;
    String direction_east;
    String direction_south;
    String emergency;
    String emergency_telephone_code;
    String fee;
    String foot;
    String highway;
    String hiking;
    ...
    String railway;
    String railway_derail;
    String railway_local_operated;
    String railway_milestone_catenary_mast;
    String railway_milestone_emergency_brake_override;
    String railway_position;
    String railway_position_exact;
    String railway_radio;
    String railway_ref;
    String railway_signal_catenary_mast;
    String railway_signal_crossing_form;
    String railway_signal_crossing_distant_form;
    String railway_signal_direction;
    String railway_signal_distant;
    String railway_signal_distant_form;
    String railway_signal_distant_height;
    String railway_signal_distant_repeated;
    String railway_signal_distant_shortened;
    String railway_signal_distant_states;
    String railway_signal_electricity;
    String railway_signal_electricity_form;
    String railway_signal_electricity_height;
    String railway_signal_electricity_turn_direction;
    String railway_signal_electricity_type;
    String railway_signal_expected_position_height;
    String railway_signal_main;
    String railway_signal_main_deactivated;
    String railway_signal_main_form;
    String railway_signal_main_function;
    String railway_signal_main_height;
    String railway_signal_main_states;
    String railway_signal_main_substitute_signal;
    String railway_signal_main_repeated;
    String railway_signal_main_repeated_form;
    String railway_signal_minor;
    String railway_signal_minor_form;
    String railway_signal_minor_height;
    String railway_signal_minor_states;
    String railway_signal_position;
    String railway_signal_shunting;
    String railway_signal_shunting_form;
    String railway_signal_shunting_height;
    String railway_signal_speed_limit;
    String railway_signal_speed_limit_form;
    String railway_signal_speed_limit_height;
    String railway_signal_speed_limit_speed;
    String railway_signal_speed_limit_distant;
    String railway_signal_speed_limit_distant_form;
    String railway_signal_speed_limit_distant_height;
    String railway_signal_speed_limit_distant_speed;
    String railway_signal_station_distant;
    String railway_signal_station_distant_form;
    String railway_signal_traversable_type;
    String railway_signal_whistle;
    String railway_signal_whistle_form;
    String railway_signal_wrong_way;
    String railway_signal_wrong_road_form;
    String railway_station_category;
    String railway_switch;
    String railway_switch_configuration;
    String railway_switch_electric;
    String railway_switch_movable_frog;
    String railway_switch_resetting;
    String railway_turnout_side;
    String razed;
    String ref;
    String ref_IFOPT;
    String ref_station;
    ...
    String tourism;
    String tower_type;
    String traffic_calming;
    String traffic_sign;
    String train;
    String uic_name;
    String uic_ref;
    String wheelchair;
    String wheelchair_description;
...
public:
    inline void ParseFromOSMJson(JsonValue json)
    {
        ...
        JsonObject obj = json.toObject();
        JsonObject tags = obj["tags"].toObject();
        ...
        if (tags.contains("railway:signal:wrong_way"))
            this->railway_signal_wrong_way = tags["railway:signal:wrong_way"].toString();

        if (tags.contains("railway:signal:wrong_way:form"))
            this->railway_signal_wrong_road_form = tags["railway:signal:wrong_way:form"].toString();
    ...
    inline JsonObject ToQJsonObject() const
    {
        ...
        if (!this->railway_signal_wrong_way.isEmpty())
            obj["railway:signal:wrong_way"] = this->railway_signal_wrong_way;

        if (!this->railway_signal_wrong_road_form.isEmpty())
            obj["railway:signal:wrong_way:form"] = this->railway_signal_wrong_road_form;
