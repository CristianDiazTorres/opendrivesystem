...
#ifndef __OSMM_RESULTGENERATOR_H__
#define __OSMM_RESULTGENERATOR_H__
...
namespace OSMM
{
    ...
    * 1: The ResultGenerator shall return one and only one OSMModuleRequestResult per Request.
    ...
    * 4: The ResultGenerator shall parse the chain of Road objects to define the next id and previous id ofeach Lane object.
    ...
    * 9: The ResultGenerator shall add LaneSection objects to the Road object adequatly, to ensure that,when parsing the Road,
    ...
    */
    ...
    public:
        ...
        OSMModuleRequestResult Process(size_t sub_requests, RoadVec& roads); // DR2
        OSMModuleRequestResult Process();

        /* append result */
        void Append(Road& road);
...
#endif // __OSMM_RESULTGENERATOR_H__
