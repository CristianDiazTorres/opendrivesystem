...
#ifndef __OSMM_REQUESTANALYZER_H__
#define __OSMM_REQUESTANALYZER_H__
...
namespace OSMM
{
    ...
    */
    ...
    public:
        ...
        RoadVec Process(ConstRequest& request, ConstQJsonArray& json_data); // SLR1, SLR2
        RoadVec Process2(ConstRequest& request, ConstQJsonArray& json_data); // SLR1, SLR2
    };

}

#endif // __OSMM_REQUESTANALYZER_H__